...
static const char *fonts[]          = { "JetBrainsMono:antialias=true:style:medium:size=12" };
//static const char *fonts[]          = { "monospace:size=14" };
static const char dmenufont[]       = "JetBrainsMono:antialias=true:style:medium:size=12";
