...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:antialias=true:style:medium:size=12" };
//static const char *fonts[]          = { "monospace:size=14" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font:antialias=true:style:medium:size=12";
